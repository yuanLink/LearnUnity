...
namespace Completed
{
	...
	public class Enemy : MovingObject
	{
		...
		public int attackSound1;						//First of two audio clips to play when attacking the player.
		public int attackSound2;						//Second of two audio clips to play when attacking the player.
		public int HP = 20;										//敌人生命
		...
		public string Enemy_ID = "0";
		private bool iscopied = false;
		private EnemiesType type_copy;
		private int GMindex = -1;
		...
		protected override void Start ()
		{
			...
			GMindex = GameManager.instance.AddEnemyToList (this);
		...
		public void BeAttack(int value)//敌人被攻击
		{
			if (value <= 0)
				return;
			HP -= value;
			if (HP <= 0)
				...
				animator.SetTrigger ("enemyBeAttacked");
		}
